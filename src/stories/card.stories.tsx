...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Card component from Jutro design system showcasing critical use cases and functionality."
      }
    }
  },
  argTypes: {
...
export const Basic = {
  args: {
    ...
    children: (
      <div className="p-4">
        <p>This is a basic card with simple content. Cards are used to group related information and actions together.</p>
      </div>
    )
  }
};
...
export const FullWidth = {
  args: {
    ...
    children: (
      <div className="p-4">
        <p>This card spans the full width of its container, useful for dashboard layouts and main content areas.</p>
...
export const WithActions = {
  args: {
    ...
    children: (
      <div className="p-4">
        <p className="mb-4">Manage your documents efficiently with our file management system.</p>
        <Flex gap="medium">
          <FlexItem>
            <Button 
              label="Upload File" 
...
// Story 6: Header Alignment Variants
export const HeaderAlignments = () => (
  <div className="space-y-4" style={{ width: "400px" }}>
    <Card title="Left Aligned" headerAlignment="left">
      <div className="p-4">
        <p>Header content is aligned to the left (default).</p>
      </div>
    </Card>
    
    <Card title="Center Aligned" headerAlignment="center">
      <div className="p-4">
        <p>Header content is centered.</p>
      </div>
    </Card>
    
    <Card title="Right Aligned" headerAlignment="right">
      <div className="p-4">
        <p>Header content is aligned to the right.</p>
      </div>
    </Card>
  </div>
);
  ...
  args: {
    children: (
      <div className="p-6">
        ...
        <p className="mb-4">This card has no predefined header, allowing for completely custom content layout.</p>
        <div className="bg-gray-100 p-3 rounded">
          <p className="text-sm">You have full control over the content structure and styling.</p>
        </div>
      </div>
    )
  }
